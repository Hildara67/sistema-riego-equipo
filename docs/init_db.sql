...
CREATE TABLE lecturas_sensores (
  ...
  FOREIGN KEY (parcela_id) REFERENCES parcelas(parcela_id) ON DELETE CASCADE,
  FOREIGN KEY (usuario_registro) REFERENCES usuarios(usuario_id) ON DELETE SET NULL
);
...
CREATE TABLE recomendaciones_riego (
  ...
  FOREIGN KEY (parcela_id) REFERENCES parcelas(parcela_id) ON DELETE CASCADE,
  FOREIGN KEY (usuario_aprobador) REFERENCES usuarios(usuario_id) ON DELETE SET NULL
);
...
CREATE TABLE config_sistema (
  ...
  FOREIGN KEY (parcela_id) REFERENCES parcelas(parcela_id) ON DELETE CASCADE,
  FOREIGN KEY (usuario_responsable) REFERENCES usuarios(usuario_id) ON DELETE SET NULL
);
